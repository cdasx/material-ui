...
var MenuItem = React.createClass({
  ...
  getStyles: function getStyles() {
    var styles = {
      ...
      rootWhenSelected: this.mergeAndPrefix({
  ...
  render: function render() {
    ...
    return React.createElement(
      'div',
      {
        ...
        style: this.mergeAndPrefix(styles.root, this.props.style, this.props.selected && styles.rootWhenSelected, this.state.hovered && !this.props.disabled && styles.rootWhenHovered, this.props.disabled && styles.rootWhenDisabled) },
      icon,
      this.props.children,
      data,
      attribute,
