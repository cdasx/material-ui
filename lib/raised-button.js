...
var RaisedButton = React.createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    ...
    this.setState({
      zDepth: zDepth,
      initialZDepth: zDepth });
    this.styles = this.getStyles(nextProps);
  },

  _getBackgroundColor: function _getBackgroundColor(props) {
    var _props = props || this.props;
    return _props.disabled ? this.getTheme().disabledColor : _props.primary ? this.getTheme().primaryColor : _props.secondary ? this.getTheme().secondaryColor : this.getTheme().color;
  },

  _getLabelColor: function _getLabelColor(props) {
    var _props = props || this.props;
    return _props.disabled ? this.getTheme().disabledTextColor : _props.primary ? this.getTheme().primaryTextColor : _props.secondary ? this.getTheme().secondaryTextColor : this.getTheme().textColor;
  },
  ...
  getStyles: function getStyles(props) {
    var _props = props || this.props;
    var amount = _props.primary || _props.secondary ? 0.4 : 0.08;
    var styles = {
      root: {
      ...
      container: {
        ...
        borderRadius: 2,
        transition: Transitions.easeOut(),
        backgroundColor: this._getBackgroundColor(_props),
      ...
      label: {
        ...
        color: this._getLabelColor(_props) },
      overlay: {
        transition: Transitions.easeOut(),
        top: 0
      },
      overlayWhenHovered: {
        backgroundColor: ColorManipulator.fade(this._getLabelColor(_props), amount)
      }
    };
    return styles;
  },
